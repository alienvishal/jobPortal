...
<div class = "main_page">
	...
	<div class = "section_menu">
		<div class="log_in"><b><h3 style="padding-left: 30px;">Login</h3></b></div>
    	...
    	<div style="border:1px solid black;border-radius: 5px;width:219px;height: 92px;margin-left: 340px;">
    		<h1 style="padding-top: 16px;"><center><a href="<?php echo base_url('Employer/login') ?>">Employer</a></center></h1></font>
    	</div>
    	<div style="border:1px solid black;border-radius: 5px;width:219px;height: 92px;margin-left: 598px;margin-top: -94px;">
    		<h1 style="padding-top: 16px;"><center><a href="<?php echo base_url('Candidate/login') ?>">Individual</a></center></h1>
    	</div>
	</div>
	<br>
	<div id = "footer">
